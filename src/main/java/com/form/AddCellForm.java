...
public class AddCellForm {
    ...
    public int get_copies_number() { return copies_number; }

    public void set_cell_id(int cell_id) { this.cell_id = cell_id; }

    public void set_collection_id(int collection_id) { this.collection_id = collection_id; }

    public void set_copies_number(int copies_number) { this.copies_number = copies_number; }
}
